...
public class Student implements Serializable {
	...
	public void setStdID(int stdID) throws IllegalArgumentException {
		if (stdID > 0) {
			...
			throw new IllegalArgumentException("Student ID must be positive value");
		}
	}
	...
	public void setCourses(ArrayList<String> courses) throws IllegalArgumentException {
		if (courses != null && !courses.isEmpty() && !courses.get(0).isEmpty()) {
			this.courses = new ArrayList<String>(courses);
		} else {
			throw new IllegalArgumentException("Please enter the course name");
		}
